...
According to the Central Limit Theorem, we expect that the distribution of sample means is normal for large enough sample sizes. The plot below presents the distribution of observations drawn from the normal distribution with the mean 5 and standard deviation 5. As we can see, our distribution of sample follow the normal distribution pattern pretty closely. 
