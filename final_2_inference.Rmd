...
To save some space in the section below we are presenting only p-value and confidence interval boundries. To see full output of t.test function please look at the Appendix 3. Please see Appendix 4 if you are interested in the code used to produce and formatt tables with hypothis test result.
